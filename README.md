# YODA-manual
Here you can find all information you need to use our local DM suite YODA.

# The YODA portal
http://yoda.i-kmb.de  
We used an internal certificate for this web service. If you haven't installed/trust the certificate already use the following steps: ...   
You can log in with your MS IKMB account to the portal.   
